...
SELECT * FROM history WHERE DIET_DIARY_MEMBERS_IDX =9;
SELECT * FROM history INNER JOIN FOOD ON HISTORY.HISTORY_IDX = FOOD.HISTORY_IDX;
SELECT * FROM food;
SELECT * FROM food WHERE HISTORY_IDX =32 ORDER BY food_idx asc;

SELECT * FROM HISTORY WHERE DIET_DIARY_MEMBERS_IDX=1 AND YEAR=2022 AND MONTH=12 ORDER BY DAY asc;
